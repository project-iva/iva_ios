...
class SleepAnalysis: CategoryModel {
    ...
    convenience init(category: Category) {
        self.init(uuid: UUID(uuidString: category.uuid)!, sourceName: category.sourceRevision.source.name, start: category.startTimestamp.asDate, end: category.endTimestamp.asDate, value: category.harmonized.value)
    }
